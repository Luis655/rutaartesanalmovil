...
class Rutaspublicas extends StatelessWidget {
  final String? fromloc;
  final String? toloc;
  Rutaspublicas({this.fromloc, this.toloc});
                ...
                children: <Widget>[
                  ...
                  Wrap(
                    ...
                    children: <Widget>[
                      ...
                      Tag(
                        label: flightTo!,
                        avatar: Icon(Icons.add_location_alt, size: 18),
                      ),
                      Tag(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              /*prefix0.locs[0]*/ 
                                  /* ' Beauty and old place */ '\n Mira la mejor seleccion de rutas creadas por la secretaria',
                            ...
                            Text(
                              /*prefix0.locs[1]*/  /*+ ' Imam reza Holy Shrine'*/'Disfruta',
                              style: TextStyle(
